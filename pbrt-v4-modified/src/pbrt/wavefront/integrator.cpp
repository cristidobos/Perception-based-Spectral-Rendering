...
WavefrontPathIntegrator::WavefrontPathIntegrator(
    ...
    : memoryResource(memoryResource), wavelengthPDFs(globalSamplingTable), exitCopyThread(new std::atomic<bool>(false)) {
...
Float WavefrontPathIntegrator::Render() {
    ...
    //     ErrorExit("SUCCESS: Integrator has a valid wavelengthPDFs pointer.");
    // } else {
    //     ErrorExit("FAILURE: Integrator's wavelengthPDFs pointer is null.");
    // }
